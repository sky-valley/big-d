...
export const DEFAULT_DB_DIR = process.env.TCP_REFERENCE_STATION_DIR ?? join(homedir(), '.differ', 'tcp-reference-station');
export const DEFAULT_DB_PATH = join(DEFAULT_DB_DIR, 'tcp-reference-station.db');
