...
- For work touching `intent-space/`, `tcp-reference-station/`, `loop/`, promise lifecycles, or agent control surfaces, apply `docs/architecture/promise-native-planning-guardrails.md` before finalizing a plan.
