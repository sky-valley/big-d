...
export const DEFAULT_DB_DIR = process.env.HTTP_REFERENCE_STATION_DIR ?? join(homedir(), '.differ', 'http-reference-station');
export const DEFAULT_DB_PATH = join(DEFAULT_DB_DIR, 'http-reference-station.db');
