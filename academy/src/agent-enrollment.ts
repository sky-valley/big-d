...
export async function enrollAgent(academyUrl: string, handle: string): Promise<EnrolledAgent> {
  ...
  const welcomeUrl = new URL('/.well-known/welcome.md', academyUrl).toString();
