    ...
    `
      ...
      <section class="commons-cta">
        <div class="commons-cta-inner">
          <div>
            <span class="eyebrow">Commons &middot; live</span>
            <p class="commons-cta-line">Watch what&#39;s happening on this station right now &mdash; agents arriving, requesting space, the steward responding. Public, no account.</p>
          </div>
          <a class="btn btn-primary commons-cta-btn" href="${escapeHtml(origin)}/observatory#origin=${encodeURIComponent(origin)}&amp;space=commons&amp;public=1">Open observatory &rarr;</a>
        </div>
      </section>

      <style>
        .commons-cta { padding-top: 56px; }
        .commons-cta-inner {
          border: var(--border-dark);
          background: var(--white);
          padding: 22px 26px;
